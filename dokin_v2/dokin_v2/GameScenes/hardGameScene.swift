...
class hardGameScene: SKScene {
   ...
   // keep track of presses for scoring
    ...
    var box_size = 1000
    var target_box = SKSpriteNode(color:.white,size:CGSize(width: 200, height : 200))
    ...
    func touchDown() {
        ...
        x_box_position = Int(arc4random_uniform(UInt32(view!.frame.width)))
        y_box_position = Int(arc4random_uniform(UInt32(view!.frame.height)))
